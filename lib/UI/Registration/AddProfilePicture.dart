...
class AddProfilePicture extends StatefulWidget {
  ...
  AddProfilePicture({this.fname, this.lname, this.dob, this.gender, this.uid, this.phone});
}
  ...
  uploadData() async {
    ...
    if (selectedImage != null) {
      ...
      Reference storageReference =
          storage.ref().child("Images/${widget.uid}/${Path.basename(selectedImage.path)}");
        ...
        child: Column(
          children: [
            ...
            RawMaterialButton(
              ...
              child: SvgPicture.asset('Assets/Profile_picture_add.svg'),
